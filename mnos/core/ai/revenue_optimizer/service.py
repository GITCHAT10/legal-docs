        ...
        for b in booking_data:
            ...
            if occupancy < 0.3 and b.avg_lead_time_days < 7:
                decisions.append(AiDecision(
                    ...
                    confidence_score=0.82,  # Low confidence for testing
                    recommendation_type="DYNAMIC_PRICING",
                    max_allowed_impact=0.20
                ))
            elif occupancy > 0.8:
                decisions.append(AiDecision(
                    module="revenue_optimizer",
                    ...
                    confidence_score=0.94,  # High confidence for testing
                    recommendation_type="YIELD_MANAGEMENT",
                    max_allowed_impact=0.10
                ))
        return decisions
