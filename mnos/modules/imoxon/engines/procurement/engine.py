class ProcurementEngine:
    ...
    def create_rfp(self, rfp_id: str, batch_id: str, items: list, suppliers: list):
        ...
        self.shadow.commit("supply.rfp_created", rfp)
        self.events.publish("RFP_OPENED", rfp)
    ...
    def submit_bid(self, supplier_id: str, rfp_id: str, total_price: float):
        ...
        self.shadow.commit("supply.bid_submitted", bid)
        self.events.publish("BID_SUBMITTED", bid)
    ...
    def award_rfp(self, rfp_id: str, supplier_id: str):
        ...
        self.shadow.commit("supply.rfp_awarded", award)
