...
def create_transfer_request(
    *,
    ...
    return service.create_transfer_request(db, request_in=request_in)
...
def update_transfer(
    ...
    if update_in.status:
        service.update_transfer_status(db, request_id=request_id, status=update_in.status)
    if update_in.vehicle_id:
        service.assign_vehicle(db, request_id=request_id, vehicle_id=update_in.vehicle_id)
    if update_in.eta:
