...
class GlobalDemandHeatmap:
    ...
    def get_national_summary(self) -> dict:
        ...
        total_tax = sum(ledger_entry["tgst"] + ledger_entry["green_tax"] for ledger_entry in self.mira.daily_ledgers.values())
    ...
    def drill_down(self, island: str) -> dict:
        ...
        island_tax = sum(r["tgst"] for r in daily_mira if self.core.mars_unified.vendors.get(r["vendor_id"], {}).get("island") == island)
