...
class MiraBridgeEngine:
    ...
    def record_transaction(self, order_data: dict):
        ...
        daily_ledger = self.daily_ledgers[key]
        daily_ledger["total_base"] += pricing["base"]
        daily_ledger["service_charge"] += pricing["service_charge"]
        daily_ledger["tgst"] += pricing["tax_amount"]
        daily_ledger["green_tax"] += pricing.get("green_tax", 0.0)
        daily_ledger["total_sales"] += pricing["total"]
        daily_ledger["tx_count"] += 1
