...
use Modules\Academy\App\Models\Submission;
use Modules\Academy\App\Services\MNOS\MnosTransaction;
use Illuminate\Http\Request;


class SubmissionController extends BaseAcademyController
{
    public function index()
    {
        return $this->mnosResponse(Submission::all());
    }
    ...
    {
        return $this->mnosResponse(Submission::findOrFail($id));
    }
