...
use Modules\Academy\App\Models\Refund;
use Modules\Academy\App\Services\MNOS\MnosTransaction;
use Illuminate\Http\Request;


class RefundController extends BaseAcademyController
{
    public function index()
    {
        return $this->mnosResponse(Refund::all());
    }
    ...
    {
        return $this->mnosResponse(Refund::findOrFail($id));
    }
