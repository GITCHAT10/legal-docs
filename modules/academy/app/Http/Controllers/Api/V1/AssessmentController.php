...
use Modules\Academy\App\Models\Assessment;
use Modules\Academy\App\Services\MNOS\MnosTransaction;
use Illuminate\Http\Request;


class AssessmentController extends BaseAcademyController
{
    public function index()
    {
        return $this->mnosResponse(Assessment::all());
    }
    ...
    {
        return $this->mnosResponse(Assessment::findOrFail($id));
    }
    ...
    public function destroy($id)
    {
        MnosTransaction::execute(function() use ($id) {
            return Assessment::findOrFail($id)->delete();
        });
