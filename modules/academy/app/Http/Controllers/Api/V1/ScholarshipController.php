...
use Modules\Academy\App\Models\Scholarship;
use Modules\Academy\App\Services\MNOS\MnosTransaction;
use Illuminate\Http\Request;


class ScholarshipController extends BaseAcademyController
{
    public function index()
    {
        return $this->mnosResponse(Scholarship::all());
    }
    ...
    {
        return $this->mnosResponse(Scholarship::findOrFail($id));
    }
    ...
    public function destroy($id)
    {
        MnosTransaction::execute(function() use ($id) {
            return Scholarship::findOrFail($id)->delete();
        });
